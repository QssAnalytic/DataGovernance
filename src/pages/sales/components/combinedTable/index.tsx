    ...
    <div >
      <div className=" relative overflow-x-auto ">
        <table className="  table-auto w-full rounded-xl border-collapse">
          ...
          <thead className="bg-[#E9EDCA]  whitespace-nowrap  sticky top-0 z-10 shadow-md">
          ...
          <tbody className="h-[312px]">
            {currentData.map((item) => (
              <tr key={item.id} className="border-b even:bg-[#fafafa] odd:bg-white">
                ...
                <td className="py-3 px-4  whitespace-nowrap   font-montserrat text-sm font-medium text-[#000000]">{item.name}</td>
