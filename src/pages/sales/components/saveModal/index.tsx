...
import { SaveOtherModalProps } from '../../types';
...
const SaveModal: FC<SaveOtherModalProps> = ({ isOpen, onClose, rowData, onSave, onChange }) => {
                    ...
                    <div className='flex justify-between'>
                        <div className='flex flex-col'>
                            ...
                            <div className="flex flex-col gap-[10px] flex-1">
                                ...
                                <Select onValueChange={(value) => onChange('BC', value)}>
