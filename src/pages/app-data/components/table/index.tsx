...
const Table: React.FC<TableProps> = ({ searchTerm }) => {
  const [data, setData] = useState<TableRow[]>([
    {
      ...
      applicationSource: "DSA Instagram",
    ...
    },
    {
      id: 3,
      name: "Nigar Safarova",
      applicationSource: "Google Ads",
      trainingName: "AI & ML Course",
      phone: "+994 552345679",
      date: "13.05.2024",
    },
    {
    ...
    {
      id: 9,
      name: "Aysel Mehdiyeva",
      applicationSource: "Referral",
      trainingName: "Product Management",
      phone: "+994 502345680",
      date: "19.05.2024",
    },
    {
  ...
  const handleSave = (id: number) => {
    setData(
      data.map((row) => (row.id === id ? { ...row, ...editFormData } : row))
    );
    setEditRowId(null);
    setEditFormData({});
  };
        ...
        <table className="min-w-full table-auto rounded-lg border-collapse border border-gray-200 ">
          <thead className="bg-[#FAFAFA]  rounded-lg">
            <tr className="text-left">
              ...
              <th className=" font-montserrat text-[12px] font-medium leading-normal text-[#000000]">
                Ad və Soyad
              </th>
              <th className="font-montserrat text-[12px] font-medium leading-normal text-[#000000] ">
                Application Source
              ...
              >
                {editRowId === item.id ? (
                  <>
                    ...
                    <td className="p-3">
                      <input
                        ...
                        onChange={(e) =>
                          handleFormChange(e, "applicationSource")
                        }
                        className="w-full border border-gray-300 rounded-lg p-2 text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    </td>
                  ...
                  <>
                    ...
                    <td className=" font-montserrat text-[14px] font-medium leading-normal text-[#000000]">
                      {item.name}
                    </td>
                    <td className=" font-montserrat text-[14px] font-medium leading-normal text-[#000000]">
      ...
      <div className="  flex justify-center mt-4">
        {Array.from({ length: totalPages }, (_, index) => (
          <button
            ...
            className={`px-4 py-2 border-[#22385F]  border-[0.5px] rounded-lg ${
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center   bg-[#000000] rounded-lg bg-opacity-70">
          <div className="bg-white p-6 rounded-lg shadow-custom w-[328px] h-[153px]">
            <h2 className="text-lg font-semibold">Əminsinizmi ?</h2>
