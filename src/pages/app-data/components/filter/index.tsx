...
const Filter: React.FC<FilterProps>  = ({ searchTerm, setSearchTerm }) => {
    ...
    return (
        <div className="flex justify-between mt-10 h-[90px] z-10 gap-[10rem]">
            <div className='flex relative justify-center  w-[296px]  border-[0.5px]  bg-[#FAFCFF] border-[#22385F] rounded-xl h-[56px]  px-[16px] py-[14px] '>
                ...
                <input id="myInput" type="text" value={searchTerm} ref={inputValue} 
            ...
            <FilterData  inputValue = {inputValue} searchTerm = {searchTerm} setSearchTerm ={setSearchTerm} />
