...
const ParticipantTable = () => {
   ...
   const headers = [
        ...
        for (let i = 1; i <= totalPages; i++) {
            buttons.push(
                <button
                    ...
                    className={`flex w-[40px] h-[40px] p-[10px] flex-col justify-center mx-1 items-center gap-[10px] flex-shrink-0 rounded-[8px] border border-[#22385F] bg-white ${currentPage === i
    ...
    return (
        <div className="absolute px-[40px] py-[40px] overflow-x-auto max-w-[1400px]">
