  ...
  return (
    <div>
      <ul className="flex items-center h-[45px] gap-[20px] text-[#BCBCBC] border-b-[1px] border-[#ECECEC] p-[0px_379px_1px_40px]">
        <li
          className={`text-center font-[Montserrat] text-[16px] not-italic font-semibold leading-normal cursor-pointer ${
            activeComponent === "ParticipantList" ? "text-black" : ""
          }`}
        ...
        <li
          className={`text-center text-[16px] not-italic font-semibold leading-normal cursor-pointer ${
            activeComponent === "TrainerHours" ? "text-black" : ""
          }`}
        ...
        <li
          className={`text-center text-[16px] not-italic font-semibold leading-normal cursor-pointer ${
            activeComponent === "AttendanceSheet" ? "text-black" : ""
          }`}
        ...
        <li
          className={`text-center text-[16px] not-italic font-semibold leading-normal cursor-pointer ${
            activeComponent === "ExecutiveReport" ? "text-black" : ""
          }`}
        ...
        <li
          className={`text-center text-[16px] not-italic font-semibold leading-normal cursor-pointer ${
            activeComponent === "ParticipantSatisfaction" ? "text-black" : ""
          }`}
