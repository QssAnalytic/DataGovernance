...
const AttendanceTable = () => {
    ...
    return (
        <div className="pl-[40px] pt-[20px] overflow-x-scroll">
            <div className="flex justify-start">
                <div>
                    ...
                    <div className="flex w-[100px] pt-[5px] gap-[2px]">
                        <div className="rounded-md bg-[#F4F7FD] flex h-10 items-center gap-7 self-stretch"><div className="text-[#22385F] font-montserrat text-[12px] font-semibold leading-normal rounded-xl flex w-[171px] h-10 pl-[55px] items-center gap-3">Full name</div></div>
            ...
            <div className=" ">
                {LessonCheckboxData?.map((data: any) => (
                    <div key={data.id} className="flex gap-4 items-center py-2">
                        <div className="text-[#22385F] font-montserrat text-[12px] font-semibold leading-normal rounded-xl flex w-[100px] h-10 pl-[35px] pr-[135px] items-center gap-3 rounded-md bg-[#F4F7FD] self-stretch whitespace-nowrap">
                            {data.fullName}
                        </div>
