    ...
    return (
        <div className={`mini w-full flex flex-col items-start gap-y-[40px] overflow-hidden`} >
            <div className='flex items-center gap-x-[34px]'>
                <div onClick={toggleMenu} className='miniBarIcon group flex p-2 items-center rounded-xl justify-center hover:bg-[rgba(34,56,95,1)] hover:cursor-pointer duration-200'>
            ...
            <div className='flex items-start gap-x-[34px]'>
                <div className={`miniBarIcon group hover:cursor-pointer duration-200 h-fit flex p-2 items-start rounded-xl justify-center hover:bg-[rgba(34,56,95,1)] ${openAccordions.sales ? "bg-[rgba(34,56,95,1)]" : ""}`}>
                ...
                <Accordion type="single"  collapsible onClick={() => handleAccordionToggle("sales")}>
                    <AccordionItem value="item-1" >
                        ...
                        <AccordionContent 
                            onClick={(e) => handleNavigation('application-data', e)} 
                            className="flex items-center gap-x-[8px] pl-[1.7rem] text-[#22385F] py-[2px] hover:bg-[rgba(34,56,95,0.39)] hover:text-white hover:cursor-pointer duration-200 rounded-xl group"
                        >
                            <span className="w-[5px] h-[5px] rounded-full bg-[#22385F] group-hover:bg-white"></span>
                            Application Data
                        </AccordionContent>
            ...
            {/* Finance Section */}
            <div className='flex items-start gap-x-[34px]'>
                <div className={`miniBarIcon group hover:cursor-pointer flex p-2 items-start rounded-xl duration-200 justify-center hover:bg-[rgba(34,56,95,1)] ${openAccordions.finance ? "bg-[rgba(34,56,95,1)]" : ""}`}>
            ...
            {/* Training Section */}
            <div className='flex items-start gap-x-[34px]'>
                <div className={`miniBarIcon group hover:cursor-pointer duration-200 flex p-2 items-center rounded-xl justify-center hover:bg-[rgba(34,56,95,1)] ${openAccordions.training ? "bg-[rgba(34,56,95,1)]" : ""}`}>
                ...
                <Accordion type="single" collapsible onClick={() => handleAccordionToggle("training")}>
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent onClick={(e) => handleNavigation('t', e)} className="flex items-center gap-x-[10px] pl-[1.7rem] text-[#22385F] py-[2px] hover:bg-[rgba(34,56,95,0.39)] hover:text-white hover:cursor-pointer duration-200 rounded-xl group">
            ...
            {/* Internship Section */}
            <div className='flex items-start gap-x-[34px]'>
                <div className={`miniBarIcon group duration-200 hover:cursor-pointer flex p-2 items-center rounded-xl justify-center hover:bg-[rgba(34,56,95,1)] ${openAccordions.internship ? "bg-[rgba(34,56,95,1)]" : ""}`}>
            ...
            {/* Career Section */}
            <div className='flex items-start gap-x-[34px]'>
                <div className={`miniBarIcon duration-200 group hover:cursor-pointer flex p-2 items-center rounded-xl justify-center hover:bg-[rgba(34,56,95,1)] ${openAccordions.career ? "bg-[rgba(34,56,95,1)]" : ""}`}>
                ...
                <Accordion type="single" collapsible onClick={() => handleAccordionToggle("career")}>
                    <AccordionItem value="item-1">
                        ...
                        <AccordionContent onClick={(e) => handleNavigation('talent-pool', e)} className="flex items-center gap-x-[10px] pl-[1.7rem] text-[#22385F] py-[2px] hover:bg-[rgba(34,56,95,0.39)] hover:text-white hover:cursor-pointer duration-200 rounded-xl group"><span className="w-[5px] h-[5px] rounded-full bg-[#22385F] group-hover:bg-white"></span>Talent Pool</AccordionContent>
                        <AccordionContent onClick={(e) => handleNavigation('vacancies', e)} className="flex items-center gap-x-[10px] pl-[1.7rem] text-[#22385F] py-[2px] hover:bg-[rgba(34,56,95,0.39)] hover:text-white hover:cursor-pointer duration-200 rounded-xl group"><span className="w-[5px] h-[5px] rounded-full bg-[#22385F] group-hover:bg-white"></span>Vacancies</AccordionContent>
                    </AccordionItem>
                </Accordion>
            </div>
        </div>
